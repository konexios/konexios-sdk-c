...
void save_api_address(konexios_host_t *host);
int restore_api_address(konexios_host_t *host);
void save_mqtt_address(konexios_host_t *host);
int restore_mqtt_address(konexios_host_t *host);
