...
device_type_telemetry_t *device_type_add_telemetry(device_type_t *dev, const char *name, const char *type, const char *desc) {
  ...
  konexios_linked_list_init(telemetry);
  konexios_linked_list_add_node_last ( dev->telemetries, device_type_telemetry_t, telemetry );
  return telemetry;
}
...
void device_type_free(device_type_t *dev) {
  ...
  konexios_linked_list_for_each_safe(telemetry, dev->telemetries, device_type_telemetry_t) {
...
int konexios_device_type_list(void) {
...
static property_t device_type_serialize(device_type_t *dev) {
  ...
  konexios_linked_list_for_each( t, dev->telemetries, device_type_telemetry_t ) {
    JsonNode *tl_element = json_mkobject();
    JsonNode *var_array = json_mkarray();
    property_map_t *var = NULL;
    konexios_linked_list_for_each ( var, t->variables, property_map_t ) {
...
int konexios_device_type_create(device_type_t *dev_type) {
...
int konexios_device_type_update(konexios_device_t *dev, device_type_t *dev_type) {
